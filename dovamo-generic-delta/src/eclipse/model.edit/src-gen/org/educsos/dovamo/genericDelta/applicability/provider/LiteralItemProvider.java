/**
 */
package org.educsos.dovamo.genericDelta.applicability.provider;
...
/**
 * This is the item provider adapter for a {@link org.educsos.dovamo.genericDelta.applicability.Literal} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LiteralItemProvider extends ExpressionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Literal_featureID_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Literal_featureID_feature", "_UI_Literal_type"),
				 ApplicabilityPackage.Literals.LITERAL__FEATURE_ID,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Literal)object).getFeatureID();
