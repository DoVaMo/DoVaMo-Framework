...
/**
 * This is the item provider adapter for a {@link org.educsos.dovamo.genericDelta.applicability.AndExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AndExpressionItemProvider extends ExpressionItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ApplicabilityPackage.Literals.AND_EXPRESSION__OPERANDS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AndExpression.class)) {
			case ApplicabilityPackage.AND_EXPRESSION__OPERANDS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ApplicabilityPackage.Literals.AND_EXPRESSION__OPERANDS,
