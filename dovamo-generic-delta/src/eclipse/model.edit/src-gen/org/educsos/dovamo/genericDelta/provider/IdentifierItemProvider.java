...
/**
 * This is the item provider adapter for a {@link org.educsos.dovamo.genericDelta.Identifier} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IdentifierItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GenericDeltaPackage.Literals.IDENTIFIER__ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GenericDeltaPackage.Literals.IDENTIFIER__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Identifier.class)) {
			case GenericDeltaPackage.IDENTIFIER__ID:
			case GenericDeltaPackage.IDENTIFIER__NAME:
