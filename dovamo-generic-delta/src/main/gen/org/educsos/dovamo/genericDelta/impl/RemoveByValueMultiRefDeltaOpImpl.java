...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Remove By Value Multi Ref Delta Op</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.educsos.dovamo.genericDelta.impl.RemoveByValueMultiRefDeltaOpImpl#getStrategy <em>Strategy</em>}</li>
 *   <li>{@link org.educsos.dovamo.genericDelta.impl.RemoveByValueMultiRefDeltaOpImpl#getIdOfRemovedValue <em>Id Of Removed Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RemoveByValueMultiRefDeltaOpImpl extends RemovalMultiRefDeltaOpImpl implements RemoveByValueMultiRefDeltaOp {
	/**
	 ...
	 * @generated
	 */
	protected RemoveByValueMultiRefDeltaOpImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return GenericDeltaPackage.Literals.REMOVE_BY_VALUE_MULTI_REF_DELTA_OP;
	}
	...
	public void setStrategy(RemovalStrategy newStrategy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GenericDeltaPackage.REMOVE_BY_VALUE_MULTI_REF_DELTA_OP__STRATEGY, oldStrategy, strategy));
	}
	...
	public void setIdOfRemovedValue(String newIdOfRemovedValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GenericDeltaPackage.REMOVE_BY_VALUE_MULTI_REF_DELTA_OP__ID_OF_REMOVED_VALUE, oldIdOfRemovedValue, idOfRemovedValue));
	}
...
} //RemoveByValueMultiRefDeltaOpImpl
