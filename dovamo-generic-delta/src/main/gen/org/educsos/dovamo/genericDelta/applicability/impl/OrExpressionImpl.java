 ...
 * </p>
 * <ul>
 *   <li>{@link org.educsos.dovamo.genericDelta.applicability.impl.OrExpressionImpl#getOperands <em>Operands</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OrExpressionImpl extends ExpressionImpl implements OrExpression {
	...
	protected EClass eStaticClass() {
		return ApplicabilityPackage.Literals.OR_EXPRESSION;
	}
	...
	public EList<Expression> getOperands() {
		if (operands == null) {
			operands = new EObjectContainmentEList<Expression>(Expression.class, this, ApplicabilityPackage.OR_EXPRESSION__OPERANDS);
		}
		return operands;
	}
