 ...
 * </p>
 * <ul>
 *   <li>{@link org.educsos.dovamo.genericDelta.applicability.impl.AndExpressionImpl#getOperands <em>Operands</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AndExpressionImpl extends ExpressionImpl implements AndExpression {
	...
	protected EClass eStaticClass() {
		return ApplicabilityPackage.Literals.AND_EXPRESSION;
	}
	...
	public EList<Expression> getOperands() {
		if (operands == null) {
			operands = new EObjectContainmentEList<Expression>(Expression.class, this, ApplicabilityPackage.AND_EXPRESSION__OPERANDS);
		}
		return operands;
	}
